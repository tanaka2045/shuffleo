...
@section('content')
  ...
  <div class="container">
      ...
      <div class="col-md-6 offset-md-3 font-o-md px-0">
        <div class="d-flex justify-content-start">
          <ul class="nav nav-tabs">
            ...
            <li class="nav-item">
              <a class="nav-link active" href="{{ action('Users\StatisticController@rankingTermAccess') }}">ターム勝率</a>
            </li>
            <li class="nav-item">
   ...
   <div class="row">
        ...
        <table class="table table-sm btn-shadow"  align="center" style="font-size: 0.9em; margin-x: 0px;">
          <thead class="thead-navcolor text-center">
            <tr>
              ...
              <th scope="col" class="align-middle" style="border: 1px solid #001F5C;">ターム勝率</th>
            </tr>
          </thead>
          <tbody>
    ...
    <div class="row">
      <div class="col font-o-esm-norm text-white mb-3">{{ __('ターム勝率は各ターム終了後に反映されます') }}</div>
    </div>

      ...
      <div class="col-lg-6 offset-lg-3 font-weight-bold" style="text-align: left;">
        ...
        <form method="POST" action="{{ route('register') }}">
          ...
          <span class="radio-inline ml-2 mr-4">
            <label>
              <input type="radio" name="gender" value="male" {{--@if(Input::old('gender')=="male") checked @endif--}}> 男
            </label>
          </span>
          <span class="radio-inline">
            <label>
              <input id="gender" type="radio" name="gender" value="female" {{--@if(Input::old('gender')=="female") checked @endif--}}> 女
            </label>
          </span>
